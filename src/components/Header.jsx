    ...
    <header className="absolute top-0 left-0 w-full z-10">
      <div className="flex items-center justify-between px-6 sm:px-10 py-3 bg-gradient-to-b from-black/80 to-transparent backdrop-blur-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          />
          <button className="px-3 py-1.5 sm:px-4 sm:py-2 text-sm sm:text-base rounded-md bg-white/10 text-white hover:bg-white/20 border border-white/20 transition">
           Sign Out
          </button>
        </div>
      </div>
